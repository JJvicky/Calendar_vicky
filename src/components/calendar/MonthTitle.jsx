...
class MonthTitle extends Component {
    ...
    render() { 
        ...
        return ( 
            <div className="month">
                <div className="arrow prev" onClick={this.props.indexMonth === 0 ? '': this.props.onClickPrev}><div></div></div>
                <ul>
                {showMonth.map((item,index)=>{
                     const className =( this.props.monthActive == index?"sub_month active":"sub_month");
                    return(
                ...
                <div className="arrow next" onClick={this.props.indexMonth == monthLength-1 ? '': this.props.onClickNext}><div></div></div>
            </div>
         );
    }
}
